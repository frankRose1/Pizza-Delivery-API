/**
 * Server related tasks for he API
 */
...
server.httpServer = http.createServer((req, res) => {
    ...
    //parse the url to get key/value pairs from the query string
    ...
    req.on('end', () => {
        ...
        const data = {
            ...
            method,
            headers,
            payload // TODO: set up a helper to parse this to an object, currently its a string
        };
