...
//array of cart ID's on the userObject that will link to a cart file that contains the actualy contents
//once the order is placed the cart ID's will be removed
